...
## Corpus Check
- 128 files · ~47,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 1232 edges · 44 communities (33 shown, 11 thin omitted)
...
Cohesion: 0.08
Nodes (27): checkedHandler(), handler, dynamic, metadata, dynamic, metadata, accessByRoute, canAccessNavigationRoute() (+19 more)
...
Cohesion: 0.39
Nodes (4): loadCbsQuality(), qualitySummary(), CbsQualityConsole(), stateClass()
...
Cohesion: 0.17
Nodes (16): approveExport(), archiveResponse(), command(), createExport(), generateExport(), getDocumentArchiveRequest(), requestDocumentArchive(), validDocumentArchiveRequest() (+8 more)
...
## Knowledge Gaps
- **170 isolated node(s):** `failures`, `sdkManifest`, `*.svg`, `nextConfig`, `name` (+165 more)
